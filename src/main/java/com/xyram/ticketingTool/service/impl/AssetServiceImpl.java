 ...
 * 
 * import com.xyram.ticketingTool.Repository.AssetRepository; import
 * com.xyram.ticketingTool.Repository.ProjectRepository; import
 * com.xyram.ticketingTool.apiresponses.ApiResponse; import
 * com.xyram.ticketingTool.apiresponses.IssueTrackerResponse; import
 ...
 * @Service
 * 
 * @Transactional public class AssetServiceImpl implements AssetService{
 * 
 * 
 * @Autowired AssetRepository assetRepository;
 * 
 * @Override public ApiResponse addasset(Asset asset) { ApiResponse response =
 * new ApiResponse(false); response = validateAsset(asset);
 * 
 * if(asset != null) { assetRepository.save(asset); response.setSuccess(true);
 * response.setMessage(ResponseMessages.ASSET_ADDED); } else {
 * response.setSuccess(false);
 * response.setMessage(ResponseMessages.ASSET_NOT_ADDED); }
 * 
 * 
 * 
 * return response; } private ApiResponse validateAsset(Asset asset) {
 * ApiResponse response = new ApiResponse(false); if (asset.getvId() != null) {
 * 
 * 
 * 
 ...
 * 
 * 
 * else { response.setMessage(ResponseMessages.VENDOR_ID_ADDED);
 * 
