...
public interface ProjectMemberRepository extends JpaRepository<ProjectMembers, String> {
	...
	@Query("Select new map(e.projectId as projectId,p.projectName as projectName) from ProjectMembers e left join  Projects p On e.projectId = p.pId left join  Employee ee On ee.eId =:employeeId" )
