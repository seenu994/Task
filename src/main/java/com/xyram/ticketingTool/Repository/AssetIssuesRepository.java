 ...
 * 
 * import com.xyram.ticketingTool.entity.Announcement; import
 * com.xyram.ticketingTool.entity.AssetIssues;
 * 
 * @Repository
 * 
 * @Transactional public interface AssetIssuesRepository extends
 * JpaRepository<AssetIssues, String> {
 * 
 ...
 * "i.resolvedDate as resolvedDate) from AssetIssues i") Page<Map>
 * getAllAssetIssues(Pageable pageable);
 * 
 * 
 * @Query("Select distinct new map(i.issueId as issueId, i.complaintRaisedDate as complaintRaisedDate,"
 * + "i.description as description, i.Solution as Solution," +
 ...
 * "where i.status = 'open')") List<Map> searchAssetIssue(@Param("searchString")
 * String issueId);
 * 
 * 
 * 
