...
public class ClientControll {
	...
	@GetMapping(value= {AuthConstants.ADMIN_BASEPATH +"/getAllClient",AuthConstants.DEVELOPER_BASEPATH +"/getAllClient",AuthConstants.INFRA_USER_BASEPATH +"/getAllClient"})
