...
public class SoftwareMasterController {
	...
	@PutMapping(value = "/editSoftwareMaster/{softwareId}")
	public ApiResponse editSoftwareMaster(@RequestBody SoftwareMaster SoftwareMasterRequest, @PathVariable String softwareId) {
	...
	@PutMapping(value = "/changeSoftwareMasterStatus/{softwareId}/{softwareMasterStatus}")
	public ApiResponse editSoftwareMasterStatus(@PathVariable String softwareId,
			@PathVariable SoftwareEnum softwareMasterStatus) {
		logger.info("Received request to change softwareMaster status to: " + softwareMasterStatus + "for softwareId: " + softwareId);
