...
//	}
	...
	@PostMapping(value = { AuthConstants.ADMIN_BASEPATH	 + "/createTickets",AuthConstants.DEVELOPER_BASEPATH + "/createTickets",AuthConstants.INFRA_ADMIN_BASEPATH + "/createTickets",
			AuthConstants.INFRA_USER_BASEPATH + "/createTickets",AuthConstants.HR_ADMIN_BASEPATH + "/createTickets",AuthConstants.HR_BASEPATH+ "/createTickets" })
	...
	@PutMapping(value = { AuthConstants.ADMIN_BASEPATH + "/cancelTicket/{ticketId}",AuthConstants.HR_ADMIN_BASEPATH + "/cancelTicket/{ticketId}", AuthConstants.INFRA_ADMIN_BASEPATH + "/cancelTicket/{ticketId}",
			...
			AuthConstants.INFRA_USER_BASEPATH + "/cancelTicket/{ticketId}",AuthConstants.HR_BASEPATH + "/cancelTicket/{ticketId}" })
	...
	@PutMapping(value = { AuthConstants.ADMIN_BASEPATH + "/resolveTicket/{ticketId}",
			...
			AuthConstants.INFRA_USER_BASEPATH + "/resolveTicket/{ticketId}",AuthConstants.INFRA_ADMIN_BASEPATH + "/resolveTicket/{ticketId}",AuthConstants.HR_BASEPATH + "/resolveTicket/{ticketId}" })
	...
	@PutMapping(value = { AuthConstants.ADMIN_BASEPATH + "/onHoldTicket/{ticketId}",
			AuthConstants.INFRA_USER_BASEPATH + "/onHoldTicket/{ticketId} ",AuthConstants.INFRA_ADMIN_BASEPATH + "/onHoldTicket/{ticketId} ",AuthConstants.HR_BASEPATH + "/onHoldTicket/{ticketId} " })
...
//		logger.info("Recive request to edit ticket by id:" + ticketRequest.getId());
	...
	@PutMapping(value = { AuthConstants.ADMIN_BASEPATH + "/reopenTicket/{ticketId}",
			AuthConstants.HR_ADMIN_BASEPATH + "/reopenTicket/{ticketId}",
			AuthConstants.INFRA_USER_BASEPATH + "/reopenTicket/{ticketId}",
			AuthConstants.DEVELOPER_BASEPATH + "/reopenTicket/{ticketId}",
			AuthConstants.INFRA_ADMIN_BASEPATH + "/reopenTicket/{ticketId}"
			,AuthConstants.HR_BASEPATH + "/reopenTicket/{ticketId}" })
...
//		logger.info("Recive request to reopened ticket by id:" + ticketRequest.getId());
	...
	@PutMapping(value = { AuthConstants.ADMIN_BASEPATH + "/addComment",AuthConstants.HR_ADMIN_BASEPATH + "/addComment",
			...
			AuthConstants.INFRA_USER_BASEPATH + "/addComment",AuthConstants.INFRA_ADMIN_BASEPATH + "/addComment",AuthConstants.HR_BASEPATH + "/addComment" })
	...
	@PutMapping(value = { AuthConstants.ADMIN_BASEPATH + "/editComment",AuthConstants.HR_ADMIN_BASEPATH + "/editComment",
			...
			AuthConstants.INFRA_USER_BASEPATH + "/editComment",AuthConstants.INFRA_ADMIN_BASEPATH + "/editComment",AuthConstants.HR_BASEPATH + "/editComment" })
	...
	@PutMapping(value = { AuthConstants.ADMIN_BASEPATH + "/deleteComment",AuthConstants.HR_ADMIN_BASEPATH + "/deleteComment",
			...
			AuthConstants.INFRA_USER_BASEPATH + "/deleteComment",AuthConstants.INFRA_ADMIN_BASEPATH + "/deleteComment",AuthConstants.HR_BASEPATH + "/deleteComment" })
	...
	@PostMapping(value = { AuthConstants.ADMIN_BASEPATH + "/searchTicket",AuthConstants.INFRA_ADMIN_BASEPATH+ "/searchTicket",
			AuthConstants.INFRA_USER_BASEPATH + "/searchTicket" ,
			AuthConstants.DEVELOPER_BASEPATH + "/searchTicket",AuthConstants.HR_ADMIN_BASEPATH + "/searchTicket",AuthConstants.HR_BASEPATH + "/searchTicket"})
...
//	public ApiResponse getAllSupportTicketsFor(Map<String,Object> filter ,Pageable pageable) {
//		logger.info("inside Ticket controller :: getAllTicket");
//		return ticketService.getAllSupporytTickets(filter,pageable);
//	}
//	
	@GetMapping(value = { AuthConstants.ADMIN_BASEPATH + "/getAllTktByStatus",AuthConstants.INFRA_ADMIN_BASEPATH + "/getAllTktByStatus",AuthConstants.HR_ADMIN_BASEPATH + "/getAllTktByStatus",
			...
			AuthConstants.DEVELOPER_BASEPATH + "/getAllTktByStatus",AuthConstants.HR_BASEPATH + "/getAllTktByStatus" })
	...
	@PutMapping(value = { AuthConstants.ADMIN_BASEPATH + "/inprogressTicket/{ticketId}",
			...
			AuthConstants.INFRA_USER_BASEPATH + "/inprogressTicket/{ticketId}",AuthConstants.INFRA_ADMIN_BASEPATH + "/inprogressTicket/{ticketId}",AuthConstants.HR_BASEPATH + "/inprogressTicket/{ticketId}" })
	...
	@GetMapping(value = { AuthConstants.ADMIN_BASEPATH + "/getTktDetailsById/{ticketId}",AuthConstants.HR_ADMIN_BASEPATH + "/getTktDetailsById/{ticketId}",AuthConstants.INFRA_ADMIN_BASEPATH + "/getTktDetailsById/{ticketId}",
			...
			AuthConstants.DEVELOPER_BASEPATH + "/getTktDetailsById/{ticketId}",AuthConstants.HR_BASEPATH + "/getTktDetailsById/{ticketId}" })
	public ApiResponse getTktDetailsById(@PathVariable String ticketId) {
		...
		@GetMapping(value = { AuthConstants.ADMIN_BASEPATH + "/getTicketSearchById/{ticketId}",
			...
			AuthConstants.DEVELOPER_BASEPATH + "/getTicketSearchById/{ticketId}",AuthConstants.INFRA_ADMIN_BASEPATH + "/getTicketSearchById/{ticketId}",AuthConstants.HR_BASEPATH + "/getTicketSearchById/{ticketId}"  })
	public ApiResponse getTicketSearchById(@PathVariable String ticketId) {
		...
		@GetMapping(value = { AuthConstants.ADMIN_BASEPATH + "/getTickets/{ticketId}",
			...
			AuthConstants.DEVELOPER_BASEPATH + "/getTickets/{ticketId}",AuthConstants.INFRA_ADMIN_BASEPATH + "/getTickets/{ticketId}",AuthConstants.HR_BASEPATH + "/getTickets/{ticketId}" })
		public ApiResponse getTicketDetailsById(@PathVariable String ticketId) {
		...
		@GetMapping(value = { AuthConstants.ADMIN_BASEPATH + "/getAllTickets",
			...
			AuthConstants.DEVELOPER_BASEPATH + "/getAllTickets",AuthConstants.INFRA_ADMIN_BASEPATH + "/getAllTickets",AuthConstants.HR_BASEPATH + "/getAllTickets"  })
		...
		//duration
		  ...
		  AuthConstants.DEVELOPER_BASEPATH + "/getAllTktByDuration/{date1}/{date2}",AuthConstants.HR_BASEPATH + "/getAllTktByDuration/{date1}/{date2}" }) 
	  ...
	  AuthConstants.DEVELOPER_BASEPATH + "/getAllTktDetails",AuthConstants.INFRA_ADMIN_BASEPATH + "/getAllTktDetails",AuthConstants.HR_BASEPATH + "/getAllTktDetails" }) 
	  ...
	  return ticketService.getAllTicketsDetails(pageable); }
		  ...
		  @GetMapping(value = { AuthConstants.ADMIN_BASEPATH + "/getTicketTotalCount",
				  ...
				  AuthConstants.DEVELOPER_BASEPATH + "/getTicketTotalCount",AuthConstants.INFRA_ADMIN_BASEPATH + "/getTicketTotalCount",AuthConstants.HR_BASEPATH + "/getTicketTotalCount" }) 
		...
		//projectName/status/
		  @GetMapping(value = { AuthConstants.ADMIN_BASEPATH + "/getTicketDetails",
				  ...
				  AuthConstants.DEVELOPER_BASEPATH + "/getTicketDetails", AuthConstants.INFRA_ADMIN_BASEPATH + "/getTicketDetails", AuthConstants.HR_BASEPATH + "/getTicketDetails" }) 
		  ...
		  @GetMapping(value = { AuthConstants.ADMIN_BASEPATH + "/getTicketCount",
				  ...
				  public  ApiResponse getTicketCount(@RequestParam Map<String, Object> filter) {
						  ...
						  return ticketService.getTicketCount(filter);
				  }
